 ...
 * </p>
 * <ul>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#getLifeline <em>Lifeline</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#getCaption <em>Caption</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#isStartEndExec <em>Start End Exec</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#isStartExec <em>Start Exec</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#isEndExec <em>End Exec</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#getEndExecCount <em>End Exec Count</em>}</li>
 *   <li>{@link de.cau.cs.kieler.kiesl.text.kiesl.impl.SelfMessageImpl#getNote <em>Note</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SelfMessageImpl extends ElementImpl implements SelfMessage
{
  /**
  ...
  {
    return KieslPackage.Literals.SELF_MESSAGE;
  }
    ...
    if (lifeline != null && lifeline.eIsProxy())
    {
      ...
      if (lifeline != oldLifeline)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, KieslPackage.SELF_MESSAGE__LIFELINE, oldLifeline, lifeline));
      }
    }
    return lifeline;
  }
  ...
  public void setLifeline(Lifeline newLifeline)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__LIFELINE, oldLifeline, lifeline));
  }
  ...
  public void setType(OneParticipantMessageType newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__TYPE, oldType, type));
  }
  ...
  public void setCaption(String newCaption)
  {
    ...
    caption = newCaption;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__CAPTION, oldCaption, caption));
  }
  ...
  public void setStartEndExec(boolean newStartEndExec)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__START_END_EXEC, oldStartEndExec, startEndExec));
  }
  ...
  public void setStartExec(boolean newStartExec)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__START_EXEC, oldStartExec, startExec));
  }
  ...
  public void setEndExec(boolean newEndExec)
  {
    ...
    endExec = newEndExec;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__END_EXEC, oldEndExec, endExec));
  }
  ...
  public void setEndExecCount(int newEndExecCount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__END_EXEC_COUNT, oldEndExecCount, endExecCount));
  }
  ...
  public void setNote(String newNote)
  {
    ...
    note = newNote;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, KieslPackage.SELF_MESSAGE__NOTE, oldNote, note));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case KieslPackage.SELF_MESSAGE__LIFELINE:
        if (resolve) return getLifeline();
        return basicGetLifeline();
      case KieslPackage.SELF_MESSAGE__TYPE:
        return getType();
      case KieslPackage.SELF_MESSAGE__CAPTION:
        return getCaption();
      case KieslPackage.SELF_MESSAGE__START_END_EXEC:
        return isStartEndExec();
      case KieslPackage.SELF_MESSAGE__START_EXEC:
        return isStartExec();
      case KieslPackage.SELF_MESSAGE__END_EXEC:
        return isEndExec();
      case KieslPackage.SELF_MESSAGE__END_EXEC_COUNT:
        return getEndExecCount();
      case KieslPackage.SELF_MESSAGE__NOTE:
        return getNote();
    }
